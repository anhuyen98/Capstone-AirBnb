        ...
        <div className="footer-img">
          ...
          <div>
            <div className="mt-[20px] mb-[40px] flex justify-center gap-[20px]">
              <div>
                <img
                  src="https://smarthome.worldtech.vn/wp-content/uploads/2017/10/cac-mau-nha-vuon-dep-1024x716.jpg"
                  alt="hinh-1"
                  style={{
                    width: "300px",
                    height: "250px",
              ...
              <div>
                <img
                  src="https://smarthome.worldtech.vn/wp-content/uploads/2017/10/mau-hinh-anh-ngoi-nha-dep-1024x576.jpg"
                  alt="hinh-2"
                  style={{
                    width: "300px",
                    height: "250px",
              ...
              <div>
                <img
                  src="https://afamilycdn.com/2020/1/9/3-15785810130461716361236.jpg"
                  alt="hinh-3"
                  style={{
                    width: "300px",
                    height: "250px",
              ...
              <div>
                <img
                  src="https://braincare.vn/wp-content/uploads/2021/10/nuoi-thu-cung.jpg"
                  alt="hinh-4"
                  style={{
                    width: "300px",
                    height: "250px",
